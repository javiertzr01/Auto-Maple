...
from src.gui.settings.tolerance import Tolerance
...
class Settings(Tab):
    def __init__(self, parent, **kwargs):
        ...
        self.tolerance_settings = Tolerance(self.column1)
        self.tolerance_settings.pack(side=tk.TOP, fill='x', expand=True, pady=(10, 0))
