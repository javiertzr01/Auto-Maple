...
<table align="center" border="0">
  <tr>
    <td width="100%">
Auto Maple has the ability to automatically solve "runes", or in-game arrow key puzzles. It runs a single inference on the captured frame against a custom-trained <b>TensorFlow</b> model with decent accuracy, even in all kinds (often colorful and chaotic) environments.
    </td>
  </tr>
</table>
...
Changes Added:
<li>
  Fixed Rune Solver - Trained own Tensorflow model to detect runes
</li>
<li>
...
<li>
  Added a record runes feature to crop the focus to the rune and record it
</li>
<li>
